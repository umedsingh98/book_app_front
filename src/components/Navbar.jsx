  ...
  const navItems = (
    <>
      <li>
        <a
          href="/"
          className="hover:scale-110 hover:bg-transparent hover:text-yellow-500 hover:bolder"
        >
          Home
        </a>
      </li>
          ...
          <div className="navbar-end">
            <div className="navbar-center hidden lg:flex">
              ...
              <label className="swap swap-rotate mr-1">
                ...
                {/* sun icon */}
                <svg
                  className="swap-off p-2 h-10 w-10 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                ...
                {/* moon icon */}
                <svg
                  className="swap-on p-2 h-10 w-10 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
